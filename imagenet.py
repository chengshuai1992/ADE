...
# ====================================Parameter====================================
parser = argparse.ArgumentParser(description='training imagenet')
...
class IMAGENET(torch.utils.data.Dataset):
    ...
    def __init__(self, root,
        ...
        self.train_labels.reshape((-1, config["num_classes"]))
...
def test():
    ...
    print('---calculate map---')
    map = calculate_top_map(qB=queryB, rB=retrievalB, queryL=queryL, retrievalL=retrievalL, topk=1000)
    print("map: ", map)
